        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-white"a href="{{ url('/about') }}">About us</a></li>
                    <li class="breadcrumb-item"><a class="text-white"a href="#">Feature</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="mb-4 pb-2">Fast & Reliable Delivery: We ensure your orders are delivered quickly and securely, offering real-time tracking for peace of mind.

                            Wide Range of Products: From groceries to electronics, we deliver anything you need, anytime you need it.

                            Affordable Pricing: Our competitive rates ensure you get the best service without breaking the bank.

                            User-Friendly App: With our intuitive app, ordering is just a few clicks away. Easily track your deliveries and manage your preferences.

                            Exceptional Customer Support: Our dedicated support team is available 24/7 to assist you with any questions or issues.

                            Sustainability Commitment: We care about the environment and use eco-friendly packaging and carbon-conscious delivery routes.</p>
                        <div class="row g-4">
                            <div class="col-6">
