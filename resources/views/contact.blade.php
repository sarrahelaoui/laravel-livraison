            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="mb-4">Contactez-nous dès maintenant avec un formulaire entièrement fonctionnel !
                            Obtenez un formulaire de contact dynamique et facile à utiliser grâce à l'intégration d'Ajax et PHP. Rapide à installer, il vous suffit de copier et coller les fichiers, ajouter quelques lignes de code, et votre formulaire sera prêt à l'emploi.
                            Besoin d’aide ? Téléchargez-le dès maintenant et commencez à recevoir des messages instantanément.</a>.</p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
